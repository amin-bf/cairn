...
│   ├── 0001-spaced-repetition-intervals.md
│   └── 0002-sqlite-for-card-storage.md
└── src/
    ├── scheduling/
    │   ├── CONTEXT.md
...
The context names above are illustrative — the real ones get established as the crate's modules take shape.
